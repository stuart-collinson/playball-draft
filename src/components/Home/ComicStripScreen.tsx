...
import { comicFont, luckiestGuyFont } from "@pbd/lib/fonts"
...
const SCORE_VALUE_CLASSES = `${luckiestGuyFont.className} comic-outline text-4xl leading-none tracking-wide text-comic-yellow`
  ...
  return (
    ...
    >
      <header className="grid shrink-0 grid-cols-[1fr_auto_1fr] items-center gap-3 border-b-4 border-black bg-comic-red px-4 py-2 text-comic-cream">
        ...
        >
          Issue #<span className={luckiestGuyFont.className}>{gameweek}</span>
        </span>
